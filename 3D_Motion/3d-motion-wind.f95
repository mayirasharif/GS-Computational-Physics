...
real(dp):: x, y, z, t, Tau, g, pi, degree, theta, voldone, voldthree, max_height, old_height, mass, vwind
integer(4):: i, nmax, n
real(dp), allocatable, dimension(:):: r, v, a, adrag, agrav, v0
...
write(*,*) "put in an axis"
read(*,*) axis

write(*,*) "put in wind velocity"
read(*,*) vwind
...
do while (r(3) > 0.0)
	...
	v(1) = voldone + Tau*a(1)
	adrag = -(1.0/2.0)*(0.45)*(.00426)*1.23*norm2(v)*v(3)/0.145
	a(1) = adrag(1) - agrav(1)
	a(2) = adrag(2) - agrav(2)
	a(3) = adrag(3) - agrav(3)
